            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/bug-report" onclick="return false;"
                            class="bg-gray-700 text-gray-400 cursor-not-allowed  rounded-md px-3 py-2 text-sm font-medium"
                            aria-disabled="true" :active="request()->is('bug-report')">Report</x-nav-link>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
